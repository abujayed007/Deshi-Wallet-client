...
const TransactionHistory = () => {
  const { data: userPhone } = useGetUserInfoQuery(undefined);
  const { data: transactions } = useGetUserTransctionsQuery(userPhone);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-white to-purple-100 p-6 md:p-12">
      {/* Wallet Card */}
      <div className="max-w-lg mx-auto bg-white/80 backdrop-blur-lg shadow-xl rounded-2xl p-6 border border-gray-200">
